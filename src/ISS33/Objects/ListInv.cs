...
namespace IIS.ISS33
{
    ...
    public class ListInv : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.ISS33.Investment fInvestment;
        
        private IIS.ISS33.Support fSupport;
        ...
        [NotNull()]
        public virtual IIS.ISS33.Investment Investment
        {
            get
            {
                ...
                IIS.ISS33.Investment result = this.fInvestment;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.ISS33.Support.
        /// </summary>
        ...
        [Agregator()]
        [NotNull()]
        public virtual IIS.ISS33.Support Support
        {
            get
            {
                ...
                IIS.ISS33.Support result = this.fSupport;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ListInvE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ListInvE", typeof(IIS.ISS33.ListInv));
                }
            }
        }
    }
    ...
    public class DetailArrayOfListInv : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.ISS33.DetailArrayOfListInv members)

        // *** End programmer edit section *** (IIS.ISS33.DetailArrayOfListInv members)
        ...
        /// </summary>
        public DetailArrayOfListInv(IIS.ISS33.Support fSupport) : 
                base(typeof(ListInv), ((ICSSoft.STORMNET.DataObject)(fSupport)))
        {
        }
        
        public IIS.ISS33.ListInv this[int index]
        {
            get
            {
                return ((IIS.ISS33.ListInv)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.ISS33.ListInv dataobject)
        {
