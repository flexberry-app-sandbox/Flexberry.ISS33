...
namespace IIS.ISS33
{
    ...
    public class Support : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.ISS33.Form fForm;
        
        private IIS.ISS33.DetailArrayOfListInv fListInv;
        
        private IIS.ISS33.DetailArrayOfListSize fListSize;
        ...
        [NotNull()]
        public virtual IIS.ISS33.Form Form
        {
            get
            {
                ...
                IIS.ISS33.Form result = this.fForm;
        ...
        public virtual IIS.ISS33.DetailArrayOfListInv ListInv
        {
            get
            {
                ...
                {
                    this.fListInv = new IIS.ISS33.DetailArrayOfListInv(this);
                }
                IIS.ISS33.DetailArrayOfListInv result = this.fListInv;
        ...
        public virtual IIS.ISS33.DetailArrayOfListSize ListSize
        {
            get
            {
                ...
                {
                    this.fListSize = new IIS.ISS33.DetailArrayOfListSize(this);
                }
                IIS.ISS33.DetailArrayOfListSize result = this.fListSize;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View SupportE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("SupportE", typeof(IIS.ISS33.Support));
                }
            }
            ...
            public static ICSSoft.STORMNET.View SupportL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("SupportL", typeof(IIS.ISS33.Support));
                }
            }
        }
    }
