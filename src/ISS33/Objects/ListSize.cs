...
namespace IIS.ISS33
{
    ...
    public class ListSize : ICSSoft.STORMNET.DataObject
    {
        ...
        [NotNull()]
        public virtual IIS.ISS33.Size Size
        {
            get
            {
                ...
                IIS.ISS33.Size result = this.fSize;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ListSizeE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ListSizeE", typeof(IIS.ISS33.ListSize));
                }
            }
        }
    }
    ...
    public class DetailArrayOfListSize : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.ISS33.DetailArrayOfListSize members)

        // *** End programmer edit section *** (IIS.ISS33.DetailArrayOfListSize members)
        ...
        /// </summary>
        public DetailArrayOfListSize(IIS.ISS33.Support fSupport) : 
                base(typeof(ListSize), ((ICSSoft.STORMNET.DataObject)(fSupport)))
        {
        }
        
        public IIS.ISS33.ListSize this[int index]
        {
            get
            {
                return ((IIS.ISS33.ListSize)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.ISS33.ListSize dataobject)
        {
